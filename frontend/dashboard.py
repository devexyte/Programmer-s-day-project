...
def render(student):
    ...
    with right_col:
        ...
        if exams:
            ...
            st.markdown("""
            <div style="background:#FFF; border:1px dashed #DACDBB; border-radius:12px; padding:24px; text-align:center; color:#71717A;">
                <p style="margin:0; font-weight:600;">No exams scheduled currently.</p>
                <small>Register your paper dates in Exam Map to start countdowns and revision schedules.</small>
            </div>
            """, unsafe_allow_html=True)
